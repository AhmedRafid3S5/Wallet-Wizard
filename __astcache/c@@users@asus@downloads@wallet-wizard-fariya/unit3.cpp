...
>>>>>>>> origin/Rumman:__astcache/c@@users@asus@downloads@wallet-wizard-fariya/unit3.cpp
...
>>>>>>>> origin/Rumman:__astcache/c@@users@asus@downloads@wallet-wizard-fariya/unit3.cpp
	  ...
	  RichEdit2->Lines->Add("\n24K Gold price per gram "+ goldPrice + "                                            | Pure Silver price per gram "+silverPrice);
	  RichEdit2->Lines->Add("---------------------------------------------------------------------------------------------------------------------------------------------");
	  ...
	  RichEdit2->Lines->Add("Annual saving must be at least " + moneyThreshold);
	}
}
//---------------------------------------------------------------------------
