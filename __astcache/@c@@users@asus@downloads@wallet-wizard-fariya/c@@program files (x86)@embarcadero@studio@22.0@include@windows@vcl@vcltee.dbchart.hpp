...
// (DO NOT EDIT: machine generated header) 'VCLTee.DBChart.pas' rev: 35.00 (Windows)
...
public:
	...
	/* {System_Generics_Collections}TList<Data_DB_TDataSource>.Create */ inline __fastcall TListOfDataSources(Data::Db::TDataSource* const *Values, const int Values_High)/* overload */ : System::Generics::Collections::TObjectList__1<Data::Db::TDataSource*>(Values, Values_High) { }
